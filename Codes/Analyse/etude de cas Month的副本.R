...
predvarGTrainTS<- ts(predvarGTrain, frequency = 1, start = 0)
...
text(97,14, "blue: Prix de l'électricité(log)",col ='blue')
text(70,14.7, "Red: Volatilité prévue",col ='red')
text(171,15.35, "Black: Taux de changement de prix de l’électricité",col ='black')
...
predvarGTestTS<- ts(predvarGTest, frequency = 1, start = 0)
